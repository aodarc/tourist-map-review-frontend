...
(function () {
  ...
  function getDummyData() {
    ...
    var singleMarker = {
      ...
      comments: [
        {user: 'Roman', text: "Зовні казковий храм, в середині світлий чистий, дуже просторий . Дуже красиві служби ,інколи мурашки бігають по шкірі. А ще оглядовий майданчик з якого видно гарну панораму міста."},
        {user: 'Олег', text: 'Перше "вау!" від когось з друзів,коли привожу їх вперше до Львова адресується цьому Храму.А як ще й вночі,то взагалі...:)' },
        {user: 'Тарас', text: 'Цей Храм одне із перших, що кидається в очі по приїзді у місто, мабуть тому що знаходиться неподалік вокзалу. Є однією з візитівок міста Лева. Вражає своєю архітектурною довершеністю і величчю, дуже красивий також і в середині.' }
      ]
    };
    var multiMarkers = {};
